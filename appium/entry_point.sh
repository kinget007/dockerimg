...
CMD="xvfb-run appium -U$ANDROID_DEVICE --port=9000 --bootstrap-port=10000 --chromedriver-port=20000 --selendroid-port=30000 --log=/root/logs/appium.log  --log-level=error --chromedriver-executable=/root/chromedrivers/${CHROMEDRIVER_VERSION}/chromedriver"
